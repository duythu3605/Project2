...
//}
//
//void GameManager::addObstacles(Obstacles* obstacles) {
//	auto foundEntity = std::find(entities.begin(), entities.end(), obstacles);
//	if (foundEntity == entities.end()) {
//		world->addChild(obstacles->getSprite());
//		entities.push_back(obstacles);
//	}
//}
//
